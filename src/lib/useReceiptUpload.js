...
- הערות (notes) - כל מידע נוסף, עמודות או פרטים מהחשבונית שלא מופים לשדות האחרים (בעברית)
- כל הפריטים/שורות בקבלה (line_items) עם:
  * תיאור (description) - תיאור של הפריט/שירות, כולל כל הפרטים הרלוונטיים שמופיעים במסמך
  * כמות (quantity) - מספר
